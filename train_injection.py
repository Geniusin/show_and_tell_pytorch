...
for epoch in range(EPOCHS):
    start.record()
    for i, (images, captions, lengths, keywords) in enumerate(data_loader):
        ...
        out = decoder(captions, feature, lengths, keywords)
    ...
    if epoch % 10 == 0:
        ...
        torch.save(decoder.state_dict(), f'./de_inj_dense{epoch}_fin.pth')
...
torch.save(encoder.state_dict(), f'./en_inj_dense{EPOCHS}.pth')
torch.save(decoder.state_dict(), f'./de_inj_dense{EPOCHS}.pth')
